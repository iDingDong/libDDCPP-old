...
#	else
struct FindHigherBound_<bidirectional> {
#	endif
...
#	else
struct FindHigherBound_<free_access> {
#	endif
...
inline UndirectionalIteratorT_ find_higher_bound(
	...
	::DD::detail_::find_higher_bound(begin__ DD_COMMA end__ DD_COMMA value__ DD_COMMA less_than)
)) {
	return ::DD::detail_::find_higher_bound(begin__, end__, value__, less_than);
}
...
inline DD_MODIFY_TRAIT(Iterator, UndirectionalRangeT_) find_higher_bound(
	...
	::DD::detail_::find_higher_bound(range__ DD_COMMA value__ DD_COMMA less_than)
)) {
	return ::DD::detail_::find_higher_bound(range__, value__, less_than);
}
