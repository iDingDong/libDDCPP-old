...
using IsUnsignedShort = AndType<detail::_IsUnsignedShort<RemoveCVType<_ObjectsT>>...>;
#	else
template <typename _ObjectT>
struct IsUnsignedShort : detail::_IsUnsignedShort<typename RemoveCV<_ObjectT>::Type> {
};
#	endif
