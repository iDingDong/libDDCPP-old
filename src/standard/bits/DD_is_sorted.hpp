...
inline ValidityType is_sorted(
	UndirectionalIteratorT_ begin__,
	UndirectionalIteratorT_ end__
) DD_NOEXCEPT_AS(::DD::detail_::is_sorted(begin__ DD_COMMA end__ DD_COMMA less_than)) {
	return ::DD::detail_::is_sorted(begin__, end__, less_than);
}
...
inline ValidityType is_sorted(
	UndirectionalRangeT_& range__
) DD_NOEXCEPT_AS(static_cast<ValidityType>(::DD::detail_::is_sorted(range__ DD_COMMA less_than))) {
	return ::DD::detail_::is_sorted(range__, less_than);
}
