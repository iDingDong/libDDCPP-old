...
inline ProcessType enlink_list_node_(ListNode<void>* position_, ListNode<void>* node_) {
...
inline ProcessType enlink_list_node_(ListNode<void>* position_, ListNode<void>* first_, ListNode<void>* last_) {
...
inline ProcessType delink_list_node_(ListNode<void>* node_) {
	node_->previous->next = node_->next;
	node_->next->previous = node_->previous;
}

inline ProcessType delink_list_node_(ListNode<void>* first_, ListNode<void>* last_) {
