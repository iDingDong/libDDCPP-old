...
inline DD_MODIFY_TRAIT(Iterator, UndirectionalRangeT3_) merge(
	...
	merge(DD_SPLIT_RANGE(range_1__) DD_COMMA DD_SPLIT_RANGE(range_2__) DD_COMMA DD_SPLIT_RANGE(result_range__))
)) {
	return merge(DD_SPLIT_RANGE(range_1__), DD_SPLIT_RANGE(range_2__), DD_SPLIT_RANGE(result_range__));
}

template <typename UndirectionalRangeT1_, typename UndirectionalRangeT2_, typename UndirectionalRangeT3_, typename BinaryPredicateT_>
inline DD_MODIFY_TRAIT(Iterator, UndirectionalRangeT3_) merge(
	UndirectionalRangeT1_& range_1__,
	UndirectionalRangeT2_& range_2__,
	BinaryPredicateT_ less__,
	...
	merge(DD_SPLIT_RANGE(range_1__) DD_COMMA DD_SPLIT_RANGE(range_2__) DD_COMMA less__ DD_COMMA DD_SPLIT_RANGE(result_range__))
)) {
	return merge(DD_SPLIT_RANGE(range_1__), DD_SPLIT_RANGE(range_2__), less__, DD_SPLIT_RANGE(result_range__));
}
